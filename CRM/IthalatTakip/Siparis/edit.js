    ...
    if ((SearchBrowserEventArgs != null) && (SearchBrowserEventArgs != '')) {
        ...
        if ((value != undefined) && (value != null)) {
            if (value.length >= 0) {
                ...
                if (e_result == 'GridUrunId2') {
                    bGridDirty = false;
                    CallbackGenel.SendCallback("GridUrunId2|" + value);
                }
...
function CallbackGenelComplete(value) {
    ...
    if ((value != null) && (value != '')) {
        ...
        if (values[1] == 'GridUrunId') {
            GridUrun.GetEditor("UrunId").SetValue(values[2]);
            GridUrun.GetEditor("Urun").SetValue(values[3]);
        }
