<%@ Page Language="C#" MasterPageFile="~/M1.master" AutoEventWireup="true" CodeFile="list.aspx.cs" Inherits="CRM_IthalatTakip_Tanim_Firma_list" %>
        ...
        <div>
            ...
            <dxwgv:ASPxGridView ID="Grid" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataColumn Caption="Firma" FieldName="Adi" Settings-AutoFilterCondition="Contains">
                        <DataItemTemplate>
                    ...
                    <dxwgv:GridViewDataColumn Caption="Sevk Þekli" FieldName="SevkSekli" Width="100px" Settings-AutoFilterCondition="Contains" />
                    <dxwgv:GridViewDataColumn Caption="Ödeme Þekli" FieldName="OdemeSekli" Width="100px" Settings-AutoFilterCondition="Contains" />
                    <dxwgv:GridViewDataTextColumn Caption="Ýskonto" FieldName="Iskonto" PropertiesTextEdit-DisplayFormatString="{0:n2}"
                        Width="60px" />
                ...
                <SettingsText Title="Firmalar" EmptyDataRow="." />
            </dxwgv:ASPxGridView>
