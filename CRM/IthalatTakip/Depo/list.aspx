<%@ Page Language="C#" MasterPageFile="~/M1.master" AutoEventWireup="true" CodeFile="list.aspx.cs" Inherits="CRM_IthalatTakip_Tanim_Depo_list" %>
        ...
        <div>
            ...
            <dxwgv:ASPxGridView ID="Grid" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataColumn Caption="Depo" FieldName="Depo" Width="30%" />
                ...
                <SettingsText Title="Depolar" EmptyDataRow="Yeni satýr ekle" />
            </dxwgv:ASPxGridView>
        </div>
  </asp:Content>