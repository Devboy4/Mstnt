<%@ Page Language="C#" MasterPageFile="~/M1.master" AutoEventWireup="true" CodeFile="list.aspx.cs" Inherits="CRM_IthalatTakip_Tanim_OdemeSekli_list" %>
        ...
        <div>
            ...
            <dxwgv:ASPxGridView ID="Grid" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataColumn Caption="Ödeme Þekli" FieldName="OdemeSekli" Width="30%" />
                    <dxwgv:GridViewDataTextColumn Caption="Gün" FieldName="Gun" Width="50px" PropertiesTextEdit-DisplayFormatString="{0:n0}" />
                ...
                <SettingsText Title="Ödeme Þekilleri" EmptyDataRow="Yeni satýr ekle" />
            </dxwgv:ASPxGridView>
        </div>
 </asp:Content>
