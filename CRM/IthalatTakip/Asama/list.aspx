<%@ Page Language="C#" MasterPageFile="~/M1.master" AutoEventWireup="true" CodeFile="list.aspx.cs" Inherits="CRM_IthalatTakip_Tanim_Asama_list" %>
        ...
        <div>
            ...
            <dxwgv:ASPxGridView ID="Grid" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataColumn Caption="Aþama" FieldName="Asama" Width="30%" />
                ...
                <SettingsText Title="Aþamalar" EmptyDataRow="Yeni satýr ekle" />
            </dxwgv:ASPxGridView>
        </div>
  </asp:Content>
