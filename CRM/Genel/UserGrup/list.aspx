<%@ Page Language="C#" AutoEventWireup="true" CodeFile="list.aspx.cs" Inherits="CRM_Genel_UserGrup_list" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <dxwgv:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                ...
                OnRowValidating="grid_RowValidating" OnRowInserting="grid_RowInserting">
                <SettingsText Title="Kullanýcý Gruplarý" GroupPanel="Gruplamak istediðiniz kolon baþlýðýný buraya s&#252;r&#252;kleyiniz."
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataColumn Width="300px" Caption="Adý" FieldName="Adi">
                        <DataItemTemplate>
                            <dxe:ASPxHyperLink CssClass="dxeBase" ID="ASPxHyperLink1" Font-Size="8pt" Font-Names="Arial" runat="server" NavigateUrl=<%#"JavaScript:PopWin = OpenPopupWinBySize('edit.aspx?id="+Eval("UserGrupID")+"',850,650);PopWin.focus();"%>
                                Text='<%#Eval("Adi")%>'>
                            </dxe:ASPxHyperLink>
                        </DataItemTemplate>
                        <EditFormCaptionStyle ForeColor="Red" />
                    </dxwgv:GridViewDataColumn>                    
                    <dxwgv:GridViewDataMemoColumn FieldName="Description" Caption="Açýklama">
