    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <dxtc:ASPxPageControl ID="ASPxPageControl2" runat="server" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                ...
                <Paddings PaddingLeft="0px" />
                <TabPages>
                    <dxtc:TabPage Name="Genel" Text="Dahil Kullanýcýlar">
                        <ContentCollection>
                            <dxw:ContentControl runat="server">
                                    ...
                                    <PanelCollection>
                                        <dxp:PanelContent runat="server">
                                            <dxwgv:ASPxGridView runat="server" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                                                ...
                                                <SettingsText Title="Kullanýcý Grubu" ConfirmDelete="Kayýt silinsin mi?" EmptyDataRow="Yeni satýr ekle" />
                                                ...
                                                <Columns>
                                                    ...
                                                    <dxwgv:GridViewDataComboBoxColumn FieldName="UserID" Caption="Kullanýcý">
                                    ...
                                    <PanelCollection>
                                        <dxp:PanelContent runat="server">
                                            <dxwgv:ASPxGridView runat="server" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                                                ...
                                                <SettingsText Title="Kullanýcý Grubu / Proje baðlantýsý" ConfirmDelete="Kayýt silinsin mi?"
