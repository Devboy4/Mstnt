<%@ Page Language="C#" MasterPageFile="~/M1.master" AutoEventWireup="true" CodeFile="list.aspx.cs" Inherits="CRM_Settings_BrRenkKodlari_list" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <div>
            ...
            <dxwgv:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                ...
                <SettingsText Title="Br Renk Kodlarý Listesi" GroupPanel="Gruplamak istediðiniz kolon baþlýðýný buraya s&#252;r&#252;kleyiniz."
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataColumn FieldName="RenkID" Visible="False">
                    </dxwgv:GridViewDataColumn>
