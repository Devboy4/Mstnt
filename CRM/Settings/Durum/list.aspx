<%@ Page Language="C#" MasterPageFile="~/M1.master" AutoEventWireup="true" CodeFile="list.aspx.cs" Inherits="CRM_Settings_Durum_list" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <div>
            ...
            <dxwgv:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                ...
                <SettingsText Title="Gündem Durum Listesi" GroupPanel="Gruplamak istediðiniz kolon baþlýðýný buraya s&#252;r&#252;kleyiniz."
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataColumn FieldName="DurumID" Visible="False">
                    </dxwgv:GridViewDataColumn>
                    ...
                    <dxwgv:GridViewDataCheckColumn Caption="Operasyon Yöntemi ve Zamaný Zorunlu Olsun"
                        FieldName="HarcananSure" Width="250px" UnboundType="Integer">
                        <PropertiesCheckEdit ValueType="System.Int32" ValueChecked="1" ValueUnchecked="0">
                        </PropertiesCheckEdit>
                    </dxwgv:GridViewDataCheckColumn>
                    <dxwgv:GridViewDataCheckColumn Caption="Gündem Giriþinde Otomatik Ýlk Getir" Width="250px"
                        FieldName="IlkGetir" UnboundType="Integer">
                        <PropertiesCheckEdit ValueType="System.Int32" ValueChecked="1" ValueUnchecked="0">
                        </PropertiesCheckEdit>
                    </dxwgv:GridViewDataCheckColumn>
