<%@ Page Language="C#" MasterPageFile="~/M1.master" AutoEventWireup="true" CodeFile="list.aspx.cs"
    Inherits="CRM_Settings_PhoneBook_list" %>
    ...
    <div>
        ...
        <dxwgv:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataColumn FieldName="FirstName" Caption="Adý">
                </dxwgv:GridViewDataColumn>
                <dxwgv:GridViewDataColumn FieldName="LastName" Caption="Soyadý">
                </dxwgv:GridViewDataColumn>
                <dxwgv:GridViewDataColumn FieldName="CompanyName" Caption="Firma">
                </dxwgv:GridViewDataColumn>
                <dxwgv:GridViewDataColumn FieldName="PhoneNumber" Caption="GSM">
                </dxwgv:GridViewDataColumn>
            </Columns>
        </dxwgv:ASPxGridView>
    </div>
