<%@ Page Language="C#" MasterPageFile="~/M1.master" AutoEventWireup="true" CodeFile="list.aspx.cs" Inherits="CRM_Settings_BrMarka_list" %>
        ...
        <div>
            ...
            <dxwgv:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataColumn FieldName="BrMarkaID" Visible="False">
                    </dxwgv:GridViewDataColumn>
