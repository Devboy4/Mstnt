...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        ...
        <dxwgv:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
            ...
            <SettingsText Title="Gündem Sýnýflarý" GroupPanel="Gruplamak istediðiniz kolon baþlýðýný buraya s&#252;r&#252;kleyiniz."
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataCheckColumn Caption="Tarih Deðiþtirilsin" FieldName="IsDateChange"
                    Width="150px">
                    ...
                    <HeaderCaptionTemplate>
                        <center>
                            Tarih<br />
                            Deðiþtirebilsin</center>
                    </HeaderCaptionTemplate>
                </dxwgv:GridViewDataCheckColumn>
                <dxwgv:GridViewDataCheckColumn Caption="Sms Gönderebilsin" FieldName="IsSendSms"
                    Width="150px">
                    <PropertiesCheckEdit ValueType="System.Int32" ValueChecked="1" ValueUnchecked="0">
                    </PropertiesCheckEdit>
                    <HeaderCaptionTemplate>
