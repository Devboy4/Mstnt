<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit.aspx.cs" Inherits="CRM_Settings_VirusSinif_edit" %>
                            ...
                            <table border="0" cellpadding="0" style="width: 700px" cellspacing="1">
                                ...
                                <tr>
                                    <td style="width: 100px">
                                        <span style="color: #CC0000;">Gündem Sınıfı</span>
                                    </td>
                                    <td colspan="5">
                                        <dxe:ASPxTextBox runat="server" ID="Adi" Width="100%" />
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Adi"
                                            ErrorMessage="Gündem Sınıfı alanı boş geçilemez!" Font-Bold="True" Display="None"
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <dxe:ASPxMemo runat="server" ID="Description" Height="74px" Width="100%" />
                                    </td>
                                </tr>
                            </table>
                            <hr />
