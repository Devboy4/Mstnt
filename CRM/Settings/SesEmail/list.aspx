<%@ Page Language="C#" MasterPageFile="~/M1.master" AutoEventWireup="true" CodeFile="list.aspx.cs" Inherits="CRM_Settings_SesEmail_list" %>
        ...
        <div>
            ...
            <dxwgv:ASPxGridView ID="Grid" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataColumn FieldName="Email" Caption="E-Posta" />
                    <dxwgv:GridViewDataMemoColumn FieldName="Aciklama" Caption="Açýklama" />
                </Columns>
                ...
                <SettingsText Title="Ses Dosyasý Gönderilen E-Posta Adresleri" EmptyDataRow="Yeni satýr ekle" />
