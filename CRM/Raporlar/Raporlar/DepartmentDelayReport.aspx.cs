...
public partial class CRM_Raporlar_Raporlar_DepartmentDelayReport : System.Web.UI.Page
{
    ...
    {       
        ...
        if (!Security.CheckPermission(this.Context, "DepartmentDelayReport", "Select"))
        {
    ...
    private void LoadDocument()
    {
        ...
        sb = new StringBuilder("EXEC GetIssuesUsersFromSelectedDepartment @FirmaId,@ProjeId,@StartDate,@EndDate");
        int tmpID = -1;
