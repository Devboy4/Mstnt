<%@ Page Language="C#" MasterPageFile="~/M1.master" AutoEventWireup="true" CodeFile="DepartmentReport.aspx.cs"
    Inherits="CRM_Raporlar_Raporlar_DepartmentReport" %>
            ...
            <PanelCollection>
                <dxrp:PanelContent ID="PanelContent1" runat="server">
                    <table border="0" cellpadding="0" cellspacing="3" style="width: 750px">
                        <tr>
                            <td align="left" style="width: 150px" valign="top">Başlangıç Tarihi
                            </td>
                            ...
                            <td align="left" valign="top">Bitiş Tarihi
                            </td>
                            <td align="left" style="width: 250px" valign="top">
