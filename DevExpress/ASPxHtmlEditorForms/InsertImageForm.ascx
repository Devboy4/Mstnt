                ...
                <table cellpadding="0" cellspacing="0">
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                                                                    <tr>
                                                                        <td class="imagePreviewCell">
                                                                            ...
                                                                            <img id="dxInsertImagePreviewImage" style="display:none;" width="180" height="100" alt="Preview Image"/>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                    ...
                    <tr>
                        <td class="moreOptionsCell">
                            <dxe:ASPxCheckBox ID="ckbMoreImageOptions" ClientInstanceName="_dxeCkbMoreImageOptions" runat="server" Text="More options">
