                ...
                <tr>
                    ...
                    <td valign="top" class="buttonTableContainer">
                        <table id="topButtonsTable" class="buttonsTable" cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <dxe:ASPxButton ID="btnIgnore" runat="server" Text="Ignore Once" Width="100%" AutoPostback="false" UseSubmitBehavior="false">
                            ...
                            <tr>
                                <td valign="top" class="verticalSeparator">
                                    <dxe:ASPxButton ID="btnIgnoreAll" runat="server" Text="Ignore All" Width="100%" AutoPostback="false" UseSubmitBehavior="false">
                            ...
                            <tr>
                                <td valign="top" class="verticalSeparator">
                                    <dxe:ASPxButton ID="btnAddToDictionary" runat="server" Text="Add to Dictionary" Width="100%" AutoPostback="false" UseSubmitBehavior="false">
                ...
                <tr>
                    ...
                    <td valign="top" class="buttonTableContainer">
                        <table id="bottomButtonsTable" class="buttonsTable" cellpadding="0px" cellspacing="0">
                            <tr>
                                <td valign="top">
                                    <dxe:ASPxButton ID="btnChange" runat="server" Text="Change" Width="100%" ClientInstanceName="_dxeSCBtnChange" AutoPostback="false" UseSubmitBehavior="false">
                            ...
                            <tr>
                                <td valign="top" class="verticalSeparator">
                                    <dxe:ASPxButton ID="btnChangeAll" runat="server" Text="Change All" Width="100%" ClientInstanceName="_dxeSCBtnChangeAll" AutoPostback="false" UseSubmitBehavior="false">
                ...
                <table cellpadding="0" cellspacing="0" style="width:100%;">
                    <tr>
                        <td align="right" class="leftBottomButton">
                            <dxe:ASPxButton ID="btnOptions" runat="server" Width="100px" Text="Options..." AutoPostback="false" UseSubmitBehavior="false">
                                <ClientSideEvents Click="function(s, e) {aspxSCShowOptionsForm(true);}"/>
                            </dxe:ASPxButton>
                        </td>
                        <td align="left" class="rightBottomButton">
                            <dxe:ASPxButton ID="btnClose" runat="server" Text="Close" Width="100%" AutoPostback="false" UseSubmitBehavior="false">
